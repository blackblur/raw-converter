...
extern "C"
{
  ...
  DllDef int libraw_dcraw_process_2(libraw_data_t *lr, ushort* toneCurves[], float* toneVals[], int toneMap);
...
public:
  ...
  int dcraw_process_2(ushort *toneCurves[], float *toneVals[], int toneMap);
  /* information calls */
  int is_fuji_rotated()
  {
